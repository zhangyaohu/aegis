...
export default {
    ...
    return {
      ...
      dataSource: {
        ...
        fields: [
          ...
          {
            getContent: item => _this.getField("INDEX_NAME", item),
            getHeaderContent: "索引名",
            tooltip: true
          },
          {
            getContent: item => _this.getField("SEG_SIZE", item),
            getHeaderContent: "存储(MB)",
            tooltip: true
          },
          {
            getContent: item => _this.getField('SQL_TOTAL', item),
            getHeaderContent: "SQL数",
            tooltip: true
          },
          {
            getContent: item => _this.getField("INDEX_TYPE", item),
            getHeaderContent: "类型",
            tooltip: true
          },
          {
            getContent: item => _this.getField("USED_STATS", item),
            getHeaderContent: "是否用",
            tooltip: true
          },
          {
            getContent: item => _this.getField("REDU_STATS", item),
            getHeaderContent: "冗余否",
            tooltip: true
					},
					{
            getContent: item => _this.getField("UNIQUENESS", item),
            getHeaderContent: "唯一否",
            tooltip: true
					},
					{
            ...
            tooltip: true
					...
					{
            getContent: item => _this.getField("INCLUDE_COLUMN", item),
            getHeaderContent: "包含列",
            tooltip: true
					}
        ]
      }
  ...
  methods: {
    ...
    queryList() {
      let _this = this;
      _this.loading = true;
      DataDictionaryApi.queryIndex(_this.getCondition()).then(resp => {
        _this
          .updateTableList({
            tableName: "role",
            list: resp.data
